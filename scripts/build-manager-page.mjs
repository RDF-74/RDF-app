...
const replacements = {
  ...
  "/* __MANAGER_APP__ */": `${await read("../manager/app.js")}\n${await read("../manager/analytics.js")}\n${await read("../manager/service-change-line.js")}\n${await read("../manager/reservation-application-import.js")}\n${await read("../manager/line-reservation-requests.js")}\n${await read("../manager/reservation-course-option-rules.js")}\n${await read("../manager/reservation-confirmation-line.js")}\n${await read("../manager/reservation-day-before-line.js")}\n${await read("../manager/reservation-quote-line.js")}\n${await read("../manager/reservation-status-auto.js")}\n${await read("../manager/reservation-cancellation-line.js")}\n${await read("../manager/reservation-change-line.js")}\n${await read("../manager/reservation-delay-line.js")}\n${await read("../manager/service-preparation-ui.js")}\n${await read("../manager/service-followup-line.js")}\n${await read("../manager/service-maintenance-line.js")}`,
};
